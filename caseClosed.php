...
<body>
  ...
  <main class="valign-wrapper">
    ...
    <div class="row center-align">
      ...
      $sql = "UPDATE diagnostic SET time_complete='" . $TimeOut . "',summary='" . $summary . "',RepairEmp_ID=" . $techID . " WHERE diag_id=" . $deviceID . "";

      //If everything works, print out the results on the page.							
      if ($mysqli->query($sql) === TRUE) {
        echo "<p>Record updated successfully.<br /><br />
 	Summary:<strong> $summary </strong><br /> 
			Tech ID:<strong> $techID</strong><br />
			Time Out:<strong> $TimeOut</strong><br />
			Device ID:<strong> $deviceID</strong> </p>";
      } else {
