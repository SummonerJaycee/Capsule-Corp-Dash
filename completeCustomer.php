...
<body>
  ...
  <main class="valign-wrapper">
    ...
    <h3 style="text-transform:uppercase;font-weight:bold;margin-bottom:40px;">Completed Customers</h3>
      ...
      <table class="striped">
        ...
        <tbody>
          <?php
          $diagquery = "SELECT * from diagnostic where time_complete IS NOT NULL";
          ...
          while ($diagrow = mysql_fetch_array($diagresult)) {
            ...
            $deviceTimeOut = $diagrow["time_complete"];
            $deviceCustID = $diagrow["customer_ID"];
            $deviceTechID = $diagrow["RepairEmp_ID"];

            echo "<tr><td>$deviceID</td><td>$deviceType</td><td>$deviceMan</td><td>$deviceModel</td><td>$deviceUser</td><td>$devicePass</td><td>$deviceDiagNeed</td><td>$deviceReferral</td><td>$deviceIssues</td><td>$deviceTimeIn</td><td>$deviceTimeOut</td><td>$deviceCustID</td><td>$deviceTechID</td></tr>";
          }
          ?>
        </tbody>
      </table>
